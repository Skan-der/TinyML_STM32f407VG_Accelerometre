...
#define AI_MODEL_MODEL_SIGNATURE     "0xa611d9c9dabc2d10bc30fcc869c107de"
...
#define AI_TOOLS_DATE_TIME   "2024-12-07T14:45:44+0100"
...
AI_ARRAY_OBJ_DECLARE(
  serving_default_keras_tensor_60_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
...
AI_TENSOR_OBJ_DECLARE(
  ...
  1, &serving_default_keras_tensor_60_output_array, NULL)
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    768, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_MODEL_IN_NUM, &serving_default_keras_tensor_60_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_MODEL_OUT_NUM, &nl_3_output),
  &gemm_0_layer, 0xcaa08d68, NULL)
