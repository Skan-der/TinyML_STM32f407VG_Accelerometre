...
#define AI_MODEL_DATA_ACTIVATIONS_SIZES \
  { 768, }
#define AI_MODEL_DATA_ACTIVATIONS_SIZE     (768)
#define AI_MODEL_DATA_ACTIVATIONS_COUNT    (1)
#define AI_MODEL_DATA_ACTIVATION_1_SIZE    (768)



#define AI_MODEL_DATA_WEIGHTS_SIZES \
  { 36372, }
#define AI_MODEL_DATA_WEIGHTS_SIZE         (36372)
#define AI_MODEL_DATA_WEIGHTS_COUNT        (1)
#define AI_MODEL_DATA_WEIGHT_1_SIZE        (36372)
