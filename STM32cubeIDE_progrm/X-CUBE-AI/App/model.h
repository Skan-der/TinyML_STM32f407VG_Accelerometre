...
#define AI_MODEL_ORIGIN_MODEL_NAME   "dnn_model"
...
#define AI_MODEL_IN_SIZE_BYTES { \
  AI_MODEL_IN_1_SIZE_BYTES, \
}
#define AI_MODEL_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_MODEL_IN_1_CHANNEL     (3)
#define AI_MODEL_IN_1_SIZE        (3)
#define AI_MODEL_IN_1_SIZE_BYTES  (12)
...
#define AI_MODEL_OUT_SIZE_BYTES { \
 ...
 * @ref ai_model_create. Both the activations memory buffer 
 ...
 */
AI_API_ENTRY
ai_buffer* ai_model_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_MODEL_*
 * defines into file @ref model.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
